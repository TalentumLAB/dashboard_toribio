...
/**
 * Specialised restore task for the dashboard block
 * (requires encode_content_links in some configdata attrs)
 *
 * TODO: Finish phpdocs
 */
class restore_dashboard_toribio_block_task extends restore_block_task {
    ...
    static public function define_decode_contents() {
        ...
        $contents[] = new restore_dashboard_block_decode_content('block_instances', 'configdata', 'block_instance');
 ...
 */
class restore_dashboard_block_decode_content extends restore_decode_content {
