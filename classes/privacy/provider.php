...
/**
 * Privacy Subsystem implementation for block_dashboard_toribio_balboa.
 *
 * @package    block_dashboard_toribio_balboa
 * @copyright  2018 Andrew Nicols <andrew@nicols.co.uk>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

namespace block_dashboard_toribio_balboa\privacy;
...
class provider implements
        // The block_dashboard_toribio_balboa block stores user provided data.
        \core_privacy\local\metadata\provider,

        // This plugin is capable of determining which users have data within it.
        \core_privacy\local\request\core_userlist_provider,

        // The block_dashboard_toribio_balboa block provides data directly to core.
        \core_privacy\local\request\plugin\provider {

    /**
     * Returns information about how block_dashboard_toribio_balboa stores its data.
     *
    ...
    public static function get_contexts_for_userid(int $userid) : \core_privacy\local\request\contextlist {
        ...
        $sql = "SELECT c.id
            ...
            INNER JOIN {context} bpc ON bpc.id = b.parentcontextid
                 WHERE b.blockname = 'dashboard_toribio'
    ...
    public static function get_users_in_context(userlist $userlist) {
        ...
        $sql = "SELECT bpc.instanceid AS userid
                 ...
                 WHERE bi.blockname = 'dashboard_toribio'
                   AND bpc.contextlevel = :contextuser
    ...
    public static function export_user_data(approved_contextlist $contextlist) {
        ...
        foreach ($instances as $instance) {
            ...
            $block = block_instance('dashboard_toribio', $instance);
            ...
            $html = writer::with_context($context)
                ->rewrite_pluginfile_urls([], 'block_dashboard_toribio', 'content', null, $block->config->text);
    ...
    public static function delete_data_for_all_users_in_context(\context $context) {
        ...
        // The only way to delete data for the dashboard_toribio block is to delete the block instance itself.
    ...
    protected static function get_instance_from_context(\context_block $context) {
        ...
        return $DB->get_record('block_instances', ['id' => $context->instanceid, 'blockname' => 'dashboard_toribio']);
    }
}
