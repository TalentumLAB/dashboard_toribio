...
/**
 * Search area for block_dashboard_toribio blocks
 *
...
namespace block_dashboard_toribio\search;
...
class content extends \core_search\base_block {
    ...
    public function attach_files($document) {
        ...
        $files = $fs->get_area_files($context->id, 'block_dashboard_toribio', 'content');
