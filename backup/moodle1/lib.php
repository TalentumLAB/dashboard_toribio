 ...
 */
class moodle1_block_dashboard_toribio_handler extends moodle1_block_handler {
    ...
    protected function convert_configdata(array $olddata) {
        ...
        $this->fileman = $this->converter->get_file_manager($contextid, 'block_dashboard_toribio');
