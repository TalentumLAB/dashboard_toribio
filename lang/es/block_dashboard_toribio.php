...
$string['maintitle'] = 'Selecciona la categoría que deseas visitar';
$string['repotitle'] = 'Acceso al repositorio de contenidos';
$string['reponotitle'] = '';
$string['gradetitle'] = 'Selecciona un nivel educativo';
$string['gradesubtitle'] = 'Al seleccionar un nivel educativo podrás elegir el grado que estas cursando o deseas consultar';
